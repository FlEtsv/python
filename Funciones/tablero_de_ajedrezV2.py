...
"""
print('pulsa 1 para poner las medidas del tablero.') #menu inicial de eleccion
...
try:#excepcion del menu
    ...
    if eleccion != 1:
        ...
        print('no hace falta que sea cuadrado. puedes hacer rectangulos')
        ...
        try:#excepciones en las medidas
